...
class TabBar: UITabBarController{
    ...
    private func tabBarConfig(){
        ...
        let listOfFlowersViewController = createNavigationControllers(
            viewControllers: ListOfFlowers(),
            tabBarItemName: "Мои Цветы",
            tabBarItemImage: "camera.macro"
        )
        let activeAlarmViewController = createNavigationControllers(
            viewControllers: ActiveAlarms(),
            tabBarItemName: "Будильники",
            tabBarItemImage: "alarm.fill")
        
        let addNewFlowerViewController = createNavigationControllers(
            viewControllers: AddNewFlower(),
            tabBarItemName: "",
            tabBarItemImage: "")
        
        viewControllers = [listOfFlowersViewController, addNewFlowerViewController, activeAlarmViewController]
    }
